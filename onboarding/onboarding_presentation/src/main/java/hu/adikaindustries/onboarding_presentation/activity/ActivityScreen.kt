...
fun ActivityScreen(
    ...
    Box(
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = {
                        viewModel.onGenderClick(ActivityLevel.Low)
                    },
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onGenderClick(ActivityLevel.Medium)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onGenderClick(ActivityLevel.High)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
        ...
        ActionButton(
            ...
            onClick = viewModel::onNextClick, modifier = Modifier.align(
            Alignment.BottomEnd))
    }
}